    ...
    */
    ...
    'connections' => [
        ...
        'app' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'pluginhound-db'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'pluginhound'),
        ...
        'test' => [
            ...
            'database' => env('DB_DATABASE_TEST', 'pluginhound'),
        ...
        'legacy' => [
            ...
            'username' => env('DB_USERNAME_LEGACY', 'app'),
            'password' => env('DB_PASSWORD_LEGACY', 'app'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
